    ...
    <section className="flex flex-col md:flex-row items-center gap-16 pt-8">
      <div className="flex-1 space-y-8 text-center md:text-left">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 leading-tight">
          Scaling Systems.<br/>
          <span className="text-slate-400 font-medium">Automating Growth.</span>
        </h1>
        <p className="text-xl text-slate-600 max-w-xl leading-relaxed mx-auto md:mx-0">
          6.5+ years of experience engineering high-performance backends for global payment systems. Specializing in <strong>Java, Spring Boot, and Distributed Caching</strong>.
        </p>
